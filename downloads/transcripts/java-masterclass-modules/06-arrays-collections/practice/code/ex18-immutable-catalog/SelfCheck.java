...
public class SelfCheck {
    public static void main(String[] args) {
        ...
        input.add(new Main.Product(" j17 ", "Java 17", tags));
        input.add(new Main.Product("algo", "Algorithms", Set.of("book")));
        Main.Catalog catalog = new Main.Catalog(input);
        tags.add("mutated"); input.clear();
