# Bài 09 — UTF-8 Error Counter

Độ khó: Hard

## Đề bài

Chủ đề: Files.lines, Charset. Kiến thức cần phủ: explicit encoding, streaming, missing file.

Encoding explicit và stream đóng đúng scope; malformed UTF-8 policy của convenience API cần ghi rõ.
