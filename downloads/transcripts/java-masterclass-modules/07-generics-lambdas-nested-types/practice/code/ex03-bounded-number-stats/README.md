# Bài 03 — Bounded Number Statistics

Độ khó: Medium

## Đề bài

Implement average and maxAsDouble for any T extending Number. Document what double conversion means for BigDecimal precision.

Chủ đề: bounded type parameters, Number.

Kiến thức cần phủ: T extends Number, Collection<? extends T>, empty policy.
