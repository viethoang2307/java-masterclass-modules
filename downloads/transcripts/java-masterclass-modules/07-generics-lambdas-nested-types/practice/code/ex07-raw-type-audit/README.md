# Bài 07 — Raw Type Audit

Độ khó: Hard

## Đề bài

Audit a legacy boundary that may contain mixed objects. Return an immutable List<String> and fail close to the boundary with a useful exception.

Chủ đề: raw types, heap pollution.

Kiến thức cần phủ: legacy boundary, validation, wildcard.
