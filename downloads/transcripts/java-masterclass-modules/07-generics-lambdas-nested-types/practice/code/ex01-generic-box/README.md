# Bài 01 — Generic Box và Pair

Độ khó: Medium

## Đề bài

Implement Box<T>, Pair<L,R>, mapLeft and describe. Keep values immutable and reject null where the contract requires it.

Chủ đề: generic class, invariance, immutable value.

Kiến thức cần phủ: T, constructor invariant, wildcard read.
