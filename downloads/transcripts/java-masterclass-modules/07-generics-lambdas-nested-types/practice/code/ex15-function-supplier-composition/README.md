# Bài 15 — Function và Supplier Composition

Độ khó: Hard

## Đề bài

Implement normalize with compose/andThen, parsePositive with a Function pipeline and orDefault with Supplier lazy behavior. Test fallback is not evaluated when value exists.

Chủ đề: Function, Supplier, lazy default.

Kiến thức cần phủ: compose/andThen, UnaryOperator, orElseGet.
