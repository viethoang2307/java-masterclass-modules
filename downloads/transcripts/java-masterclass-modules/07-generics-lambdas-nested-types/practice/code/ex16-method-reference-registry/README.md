# Bài 16 — Method Reference Registry

Độ khó: Hard

## Đề bài

Create a registry using constructor references, a length mapper using an unbound method reference, and a printer callback.

Chủ đề: method references.

Kiến thức cần phủ: constructor/static/bound/unbound references.
