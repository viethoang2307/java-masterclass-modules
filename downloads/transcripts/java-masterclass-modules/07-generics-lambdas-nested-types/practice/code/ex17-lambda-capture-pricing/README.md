# Bài 17 — Lambda Capture Pricing

Độ khó: Hard

## Đề bài

Implement discount(int) returning a UnaryOperator<BigDecimal>. Capture an effectively-final immutable factor and use explicit rounding.

Chủ đề: capture, effectively final, BigDecimal.

Kiến thức cần phủ: captured value, immutable arithmetic, no shared mutation.
