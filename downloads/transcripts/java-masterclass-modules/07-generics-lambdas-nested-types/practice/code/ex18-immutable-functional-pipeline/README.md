# Bài 18 — Immutable Functional Pipeline

Độ khó: Very Hard

## Đề bài

Implement an immutable generic Pipeline with of, filter, map and toList. Use Predicate/Function variance and return new pipelines instead of mutating old ones.

Chủ đề: generic pipeline, nested type, lambdas.

Kiến thức cần phủ: map/filter, variance, immutability.
